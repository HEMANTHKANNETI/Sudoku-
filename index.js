...
function startGame() 
{
    ...
    //Set lives to three and enable selecting nums and tiles
...
function updateMove() 
{
    ...
    if (selectedTile && selectedNum) 
    {
        ...
        //if the number matches the corresponding number in the solutin key
...
function checkCorrect(tile) 
{
    ...
    //if tile num  is equal to solution num
